...
keyboard_info = Keyboard(inline=True)
keyboard_info.add(Callback('🕵️‍♂️Об аккаунте', {'dnevnik': 'infoStudent'}))
keyboard_info.add(Callback('🏫О школе', {'dnevnik': 'infoSchool'}))
keyboard_info.row()
keyboard_info.add(Callback('👀Активные сессии', {'dnevnik': 'infoSessions'}))
keyboard_info = keyboard_info.get_json()
...
async def accounts(uid):
    ...
    for account in accounts:
        ...
        keyboard.row()
    keyboard.add(Callback('📩Импортировать аккаунты', {"cmd": 'import_account'}))
    keyboard.row()
